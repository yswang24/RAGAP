...
#SBATCH --output=output-train-cluster_hid512_2layer_4heads_20.10_512_neg20_evl10_ph2_p0.5_1e-3_cos.txt        # 输出日志的文件名
...
python train_hgt_phage_host_weight.py \
  ...
  --neg_ratio 20 \
  --eval_neg_ratio 10 \
  --save_path best_hgt_nb_cluster_hid512_2layer_4heads_20.10_512_neg20_evl10_ph2_p0.5_1e-3_cos.pt\
...
python train_hgt_phage_host_weight_copy.py \
  ...
  --neg_ratio 20 \
  --eval_neg_ratio 10 \
  --save_path best_GAT_cluster_softce_hid512_2layer_4heads_20.10_512_neg20_evl10_ph2_p0.5_5e-4_cos.pt\
