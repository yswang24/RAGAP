...
python build_hetero_graph_with_splits.py \
  ...
  --protein_clusters RBP_phage_host_650.parquet \
  --taxonomy taxonomy_poincare_tangent.parquet \
  --edge_dir edges_RBP/ \
  --pairs_train pairs_train.tsv \
  --pairs_val pairs_val.tsv \
  --pairs_test pairs_test.tsv \
  --out hetero_graph_with_features_splits4_RBP_650_613.pt \
  --map_out node_maps_RBP_650_613.json


python build_hetero_graph_with_splits.py \
  --phage_catalog phage_catalog4.parquet \
  --host_catalog host_catalog4.parquet \
  --protein_clusters cluster_phage_host_catalog_650.parquet \
  --taxonomy taxonomy_poincare_tangent.parquet \
  --edge_dir edges_RBP/ \
  --pairs_train pairs_train.tsv \
  --pairs_val pairs_val.tsv \
  --pairs_test pairs_test.tsv \
  --out hetero_graph_with_features_splits4_cluster_650_613_no_phage_tax.pt \
  --map_out node_maps_cluster_650_no_phage_tax.json
...
python build_hetero_graph_with_splits.py \
  ...
  --pairs_val pairs_val.tsv \
  --pairs_test pairs_test.tsv \
  --out hetero_graph_with_features_splits4_cluster_650_613_xiao.pt \
  --map_out node_maps_cluster_650_613_xiao.json
###cleean dataset
  python build_hetero_graph_with_splits.py \
  --phage_catalog phage_catalog4.parquet \
  --host_catalog host_catalog4.parquet \
  ...
  --pairs_val pairs_val.tsv \
  --pairs_test pairs_test.tsv \
  --out hetero_graph_with_features_splits4_cluster_650_new_data.pt \
  --map_out node_maps_cluster_650_new_data.json
...
def build_hetero(args):
    ...
    edges_spec = {
        ...
        ("host", "belongs_to", "taxonomy"): os.path.join(args.edge_dir, "host_taxonomy_edges.tsv"),
        ("taxonomy", "related", "taxonomy"): os.path.join(args.edge_dir, "taxonomy_taxonomy_edges.tsv"),
        ("phage", "belongs_to", "taxonomy"): os.path.join(args.edge_dir, "phage_taxonomy_edges.tsv"),
    }
