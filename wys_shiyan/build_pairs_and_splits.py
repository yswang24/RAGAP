...
Usage:
 python build_pairs_and_splits.py \
   --raw_pairs /home/wangjingyuan/wys/WYSPHP/virus_host_with_GCF.tsv \
   --host_catalog data_processed4/host_catalog4.parquet \
   --taxonomy_parquet /home/wangjingyuan/wys/WYSPHP/taxonomy_tree/taxonomy_with_alias.parquet \
   --out_dir data_processed_new \
   --split random --seed 613
"""
