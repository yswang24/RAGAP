...
raw_refs="""
1. PHANOTATE: a novel approach to gene identification in phage genomes (McNair et al.)
2. Prodigal: prokaryotic gene recognition and translation initiation site identification (Hyatt et al.)
3. Evolutionary-scale prediction of atomic-level protein structure with a language model (Lin et al.)
4. Large-scale sequence comparisons with sourmash (Pierce et al.)
