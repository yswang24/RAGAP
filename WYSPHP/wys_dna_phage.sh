#!/bin/bash
#SBATCH --job-name=dnabert_phage       # 作业名称
#SBATCH --output=dnabert_phage_unique.txt        # 输出日志的文件名
...
#   --fasta /home/wangjingyuan/wys/phage_fasta_final \
#   --model /home/wangjingyuan/wys/WYSPHP/DNA_bert_6 \
#   --out_dir dnabert4_phage_embeddings_final/ \
#   --k 6 \
#   --window_tokens 510 \
#   --stride_tokens 510 \
#   --batch_size 32 \
...
python dna_bert_embed.py \
  --fasta /home/wangjingyuan/wys/duibi/cherry_all_fasta \
  --model /home/wangjingyuan/wys/WYSPHP/DNA_bert_4 \
  --out_dir /home/wangjingyuan/wys/duibi/cherry_all_fasta_dnaemb \
  --k 4 \
  --window_tokens 510 \
  --stride_tokens 510 \
  --batch_size 32 \
