...
python build_hetero_graph_with_splits.py \
  --phage_catalog phage_catalog.parquet \
  --host_catalog host_catalog.parquet \
  --protein_clusters /home/wangjingyuan/wys/duibi/cherry_all_fasta_faa/protein_catalog.parquet \
  --taxonomy taxonomy_poincare_tangent.parquet \
  --edge_dir edges_na/ \
  --pairs_train pairs_train.tsv \
  --pairs_val pairs_val.tsv \
  --pairs_test pairs_test.tsv \
  --out hetero_graph_with_features_splits_cherry_retrain_common_na.pt \
  --map_out node_maps_cherry_retrain_common_na.json
